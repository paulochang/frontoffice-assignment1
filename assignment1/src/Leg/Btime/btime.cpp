...
double
Actual_360::compute_daycount_boost(const boost::gregorian::date &bfrom, const boost::gregorian::date &bto) const {
	return (bto - bfrom).days();
}

//Thirty_360 - compute_daycount_1(years, months, days_from, days_to)
double Thirty_360::compute_daycount_1(const short years, const short months, const short days_from,
...
double
Thirty_360::compute_daycount_boost(const boost::gregorian::date &bfrom, const boost::gregorian::date &bto) const {
