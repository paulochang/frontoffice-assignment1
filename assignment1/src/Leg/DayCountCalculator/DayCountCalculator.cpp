...
public:
    ...
    double
    Thirty_360::compute_daycount(const short years, const short months, const short days_from, const short days_to) {
        return ((360 * years) + (30 * (months - 1)) + std::max<short>(0, (30 - days_from)) +
